...
[Serializable]
public partial class SkyBoxFullScreenPassRendererFeature : ScriptableRendererFeature
{
    /// <summary>
    ...
    private SkyBoxRenderPass m_FullScreenPass;

    /// <inheritdoc/>
    public override void Create()
    {
        m_FullScreenPass = new SkyBoxRenderPass(name);
    }
    ...
    internal class SkyBoxRenderPass : ScriptableRenderPass
    {
        ...
        public SkyBoxRenderPass(string passName)
        {
