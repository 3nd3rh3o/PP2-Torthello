...
namespace Tortello
{
    public class ToreBoardInputSystem : IBoardInputSystem
    {
        private readonly ToreBoardSettings settings;
        ...
        public ToreBoardInputSystem(ToreBoardSettings settings, Transform boardTransform, InputActionAsset actionMap)
        {
